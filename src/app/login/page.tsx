...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      login("user@example.com", "Creator");
      ...
      >
        <div className="rounded-[32px] border border-white/5 bg-white/[0.02] backdrop-blur-2xl p-8 md:p-10 shadow-2xl">
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center"><span className="px-3 bg-transparent text-[10px] font-bold text-gray-500 uppercase tracking-widest bg-[#0c0c11]">Or continue with</span></div>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-10">
            ...
            <Link href="/signup" className="text-white font-bold hover:text-indigo-400 transition-colors">Sign Up</Link>
          </p>
        </div>
      </motion.div>
    </div>
