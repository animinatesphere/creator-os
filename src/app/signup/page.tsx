...
export default function SignupPage() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      login("newuser@example.com", "Creator");
      router.push("/dashboard");
    }, 1500);
  };

  return (
    <div className="min-h-screen bg-[#060608] flex items-center justify-center p-6 selection:bg-indigo-500/30">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-blue-600/10 blur-[100px] rounded-full" />
        <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-indigo-600/10 blur-[100px] rounded-full" />
      </div>
      ...
      >
        <div className="rounded-[32px] border border-white/5 bg-white/[0.02] backdrop-blur-2xl p-8 md:p-10 shadow-2xl">
          <div className="text-center space-y-2 mb-10">
            ...
            <p className="text-gray-400 text-sm">Join the next generation of digital creators.</p>
          </div>
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center"><span className="px-3 bg-transparent text-[10px] font-bold text-gray-500 uppercase tracking-widest bg-[#0c0c11]">Or sign up with</span></div>
          </div>

          <div className="grid grid-cols-2 gap-3 mt-6">
            <button className="flex items-center justify-center h-11 rounded-[12px] border border-white/5 bg-white/5 hover:bg-white/10 transition-all text-sm font-medium gap-2 text-white">
          ...
          <p className="text-center text-sm text-gray-500 mt-10">
            ...
            <Link href="/login" className="text-white font-bold hover:text-indigo-400 transition-colors">Log In</Link>
          </p>
        </div>
      </motion.div>
    </div>
